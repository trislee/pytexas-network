...
ENTITIES_BY_COUNT_TSV = REPO_ROOT / "entities_by_count.tsv"
ENTITIES_ALPHABETICAL_TSV = REPO_ROOT / "entities_alphabetical.tsv"
ENTITIES_BY_COUNT_CONSOLIDATED_TSV = REPO_ROOT / "entities_by_count_consolidated.tsv"
ENTITIES_ALPHABETICAL_CONSOLIDATED_TSV = REPO_ROOT / "entities_alphabetical_consolidated.tsv"
